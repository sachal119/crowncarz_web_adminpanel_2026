...
<div class="d-flex justify-content-between align-items-center mb-4">
  <h1 class="h3 fw-bold" style="color: #6B3E26;">Cancelled Job</h1>

</div>
<!-- Search & Filters -->
<div class="card shadow-sm border-0 mb-4">
  <div class="card-body bg-light rounded">
      <form action="{{ route('cancelled.bookings.search') }}" method="GET" class="row g-3 align-items-end">
      <div class="col-md-4">
      ...
      <div class="col-md-12 text-end">
        ...
        <!-- 🔄 Reset Button -->
        <a href="{{ route('bookings.cancelled') }}" class="btn btn-outline-secondary ms-2">
...
<div class="card shadow-sm border-0" style="background-color: #FFF5CC; border-left: 5px solid #D39F61;">
  <div class="card-body">
    <h5 class="card-title mb-3 fw-semibold" style="color: #A86B32;">Cancelled Bookings<span class="ms-2">({{ count($cancelledBookings) }})</span></h5>
...
<td>
    ...
    <span class="statusSelectStyle" style="{{ $style }}">
        {{ ucfirst(str_replace('_', ' ', $currentStatus)) }}
          ...
          @empty
          <tr>
            <td colspan="8" class="text-center text-muted py-4">No cancelled bookings found.</td>
          </tr>
          @endforelse
        </tbody>
      </table>
